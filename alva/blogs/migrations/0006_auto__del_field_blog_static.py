...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'blogs_blog', 'static',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'blog_static', null=True, to=orm['fileshack.Store'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            'galleries': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'blog_gallery'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['fileshack.Store']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'static': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'blog_static'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['fileshack.Store']"}),
