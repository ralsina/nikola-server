...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.theme'
        db.add_column(u'blogs_blog', 'theme',
                      self.gf('django.db.models.fields.CharField')(default=u'site', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.theme'
        db.delete_column(u'blogs_blog', 'theme')
