...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blogs_blog', 'static',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'blog_static', null=True, to=orm['fileshack.Store']),
                      keep_default=False)
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            'static': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'blog_static'", 'null': 'True', 'to': u"orm['fileshack.Store']"}),
