...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.galleries'
        db.add_column(u'blogs_blog', 'galleries',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'blog_gallery', null=True, to=orm['fileshack.Store']),
                      keep_default=False)

        # Adding field 'Blog.static'
        db.add_column(u'blogs_blog', 'static',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'blog_static', null=True, to=orm['fileshack.Store']),
                      keep_default=False)

        # Removing M2M table for field galleries on 'Blog'
        db.delete_table(db.shorten_name(u'blogs_blog_galleries'))

        # Removing M2M table for field static on 'Blog'
        db.delete_table(db.shorten_name(u'blogs_blog_static'))


    def backwards(self, orm):
        # Deleting field 'Blog.galleries'
        db.delete_column(u'blogs_blog', 'galleries_id')

        # Deleting field 'Blog.static'
        db.delete_column(u'blogs_blog', 'static_id')

        # Adding M2M table for field galleries on 'Blog'
        m2m_table_name = db.shorten_name(u'blogs_blog_galleries')
        ...
        # Adding M2M table for field static on 'Blog'
        m2m_table_name = db.shorten_name(u'blogs_blog_static')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm[u'blogs.blog'], null=False)),
            ('store', models.ForeignKey(orm[u'fileshack.store'], null=False))
